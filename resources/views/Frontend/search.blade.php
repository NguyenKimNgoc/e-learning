                ...
                <div class="col-xs-12 a-left">
                    <div class="breadcrumb-container">
                        <ul class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                            ...
                            <li><strong><span itemprop="title">Kết quả tìm kiếm ({{count($listCourse)}})</span></strong></li>
            ...
            @foreach($listCourse as $course)
                <div class="col-md-4 product-item-new">
                    <div class="item">
                        ...
                        <a href="{{route('product-detail',['id'=>$course->id,'slug_course'=> $course->slug_course])}}" class="item-title"><h4>{!! $course->c_title !!}</h4></a>
                        <div class="comments">
