    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{route('user-edit',['id'=>$userEdit->id,'slug_user'=>$userEdit->slug_user])}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group {{ !empty($errors->first('full_name')) ? 'has-warring' : '' }}">
                                ...
                                <input type="text" class="form-control" name="full_name"
                                       value="{!! old('full_name',$userEdit->full_name) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('email')) ? 'has-warring' : '' }}">
                                ...
                                <input type="email" class="form-control" name="email"
                                       @if($errors->has('email')) autofocus @endif value="{!! old('email',$userEdit->email) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('password')) ? 'has-warring' : '' }}">
                                ...
                                <input type="password" class="form-control" id="password" name="password"
                                       @if($errors->has('password')) autofocus @endif value="{!! old('password'),$userEdit->password !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('retypepassword')) ? 'has-warring' : '' }}">
                                ...
                                <input type="password" class="form-control" name="retypepassword"
                                       ...
                                       id="retypePassword" placeholder="Nhập Lại Mật  Khẩu...">
                            ...
                            <div class="form-group {{ !empty($errors->first('address')) ? 'has-warring' : '' }}">
                                ...
                                <input type="text" class="form-control" name="address"
                                       @if($errors->has('address')) autofocus @endif value="{!! old('address',$userEdit->address) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('phone')) ? 'has-warring' : '' }}">
                                ...
                                <input type="number" class="form-control" name="phone" maxlength="11"
                                       @if($errors->has('phone')) autofocus @endif value="{!! old('phone',$userEdit->phone) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('avatar')) ? 'has-warring' : '' }}">
                                ...
                                <input type="file" class="form-control" onchange='openFile(event)' name="avatar"
                                       @if($errors->has('avatar')) autofocus @endif  value="{!! old('avatar',$userEdit->avater) !!}"
                                       placeholder="">
                                <img id="output" src="{{url('/')}}{{$userEdit->avatar}}" style="margin-top: 15px ;width:100%" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ !empty($errors->first('birthday')) ? 'has-warring' : '' }}">
                                ...
                                <input type="text" class="form-control" id="datepicker"
                                       @if($errors->has('birthday')) autofocus @endif value="{!! old('birthday',$userEdit->birthday) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('industries')) ? 'has-warring' : '' }}">
                                ...
                                <select name="industries" id="input" class="form-control select-industries"
                                    ...
                                    @foreach($listIndustries as $industries)
                                        <option value="{{$industries->id}}" {{ $industries->id == old('industries',$userEdit->industries) ? "selected" : "" }}>{{$industries->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ !empty($errors->first('major')) ? 'has-warring' : '' }}">
                                ...
                                <select name="major" id="input" class="form-control select-major"
                                    ...
                                    @foreach($listMajor as $major)
                                        <option value="{{$major->id}}" {{ $major->id == old('major',$userEdit->major) ? "selected" : "" }}>{{$major->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ !empty($errors->first('skype')) ? 'has-warring' : '' }}">
                                ...
                                <input type="text" class="form-control" name="skype"
                                       @if($errors->has('skype')) autofocus @endif value="{!! old('skype',$userEdit->skype) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('facebook')) ? 'has-warring' : '' }}">
                                ...
                                <input type="text" class="form-control" name="facebook"
                                       @if($errors->has('facebook')) autofocus @endif  value="{!! old('facebook',$userEdit->facebook) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('youtube')) ? 'has-warring' : '' }}">
                                ...
                                <input type="text" class="form-control" name="youtube"
                                       @if($errors->has('youtube')) autofocus @endif value="{!! old('youtube',$userEdit->youtube) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('linkedin')) ? 'has-warring' : '' }}">
                                ...
                                <input type="text" class="form-control" name="linkedin"
                                       @if($errors->has('linkedin')) autofocus @endif value="{!! old('linkedin',$userEdit->linkedin) !!}"
                            ...
                            <div class="form-group {{ !empty($errors->first('user_group_id')) ? 'has-warring' : '' }}">
                                ...
                                <select name="user_group_id" class="form-control "
                                    ...
                                    @foreach($userGroup as $userGroupId)
                                        <option value="{{$userGroupId->id}}" {{ $userGroupId->id == old('user_group_id',$userEdit->user_group) ? "selected" : "" }}>{{$userGroupId->name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-success"><i class="fa fa-user-plus"></i> Cập Nhât Thành Viên
                        </button>
                    </div>
                </form>
            </div>
